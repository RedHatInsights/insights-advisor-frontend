import '../../../PresentationalComponents/RulesTable/_RulesTable.scss';
...
} from '../../../PresentationalComponents/RulesTable/helpers';
import { useActionsResolver } from '../../../PresentationalComponents/RulesTable/useActionsResolver';
import impactingFilter from '../../../PresentationalComponents/Filters/impactingFilter';
import { AccountStatContext } from '../../../ZeroStateWrapper';
import { SkeletonTable } from '@patternfly/react-component-groups';
import { EnvironmentContext } from '../../../App';

const IopRulesTable = ({ isTabActive, pathway }) => {
  const intl = useIntl();
  ...
  const toggleRulesDisabled = (rule_status) => {
    ...
    // Remove impacting filters when switching away from enabled recommendations
    // because disabled recommendations may have 0 impacted systems
    if (rule_status !== 'enabled') {
      delete newFilters.impacting;
      delete newFilters.update_method;
    }
...
IopRulesTable.propTypes = {
  isTabActive: PropTypes.bool,
  pathway: PropTypes.string,
};

export default IopRulesTable;
