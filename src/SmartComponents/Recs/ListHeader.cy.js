                              ...
                              bodyContent={
                                <TextContent>
                                  <Flex direction={{ default: 'column' }}>
                                    <Text component={'p'}>
                                      The advisor service assesses and monitors
                                      the health of your Red Hat Enterprise
                                      Linux (RHEL) infrastructure, and provides
                                      recommendations to address availability,
